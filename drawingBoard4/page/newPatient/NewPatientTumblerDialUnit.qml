   ...
   // GridLayout{
    Grid{
        ...
        Label {
            ...
            bottomPadding: 10
            anchors.left: parent.left
            anchors.top: subRec0.top
            anchors.verticalCenter: dataTumbler.verticalCenter
         ...
         //   Layout.minimumHeight: 75//0//0
            ...
            width: 100
            height:dataTumbler.height//4// dataSwitchRec.height//50//100//mainRec.height/15
...
//        Rectangle {
//            id: mainsubRec
//            anchors.left:label.right//dataSwitchRec.right
...
//                }
                Rectangle{
                   ...
                   // Layout.columnSpan: 2
                    ...
                    //anchors.right: parent.right
                    //Layout.fillWidth: true
                    //anchors.top:parent.top//subRec1.visible? subRec1.bottom:subRec.visible?subRec.bottom:parent.top
                    anchors.left: label.right
                    anchors.verticalCenter: parent.verticalCenter
                    anchors.horizontalCenter: parent.horizontalCenter
                    anchors.leftMargin: 20
                    anchors.rightMargin: 20
                    anchors.topMargin: 50//eyeColorDialVisibilty?25:10
